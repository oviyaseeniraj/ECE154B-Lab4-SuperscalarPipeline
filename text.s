...
OUTER:  beq     t3, t4, END        # using on purpose not   	# 03de0e63	20
	andi    t1, t3, 1          # y=outer&1 	  				    # 001e7313	24
	and     t2, t0, t1         # z=x&y       z=x&y				# 0062f3b3	28
	beq     t0, x0, SKIPX       								# 00028463	2c
	addi    s0, s0, 1            # countx++;					# 00140413	30
SKIPX:  beq     t1, x0, SKIPY      								# 00030463	34
	addi    s1, s1, 1            # county++;					# 00148493	38
SKIPY:  beq     t2, x0, SKIPZ      								# 00038463	3c
